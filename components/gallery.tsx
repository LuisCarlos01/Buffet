    ...
    <section id="galeria" className="py-20 px-4 bg-muted/30">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-4 px-4">Galeria de Eventos</h2>
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto px-4">Veja alguns dos nossos eventos realizados</p>
        </div>
